...
export const tools: Tool[] = [
  ...
  },
  {
    id: "39",
    name: "Business Docs",
    description: "Create invoices, receipts, and contracts — ready to print or export",
    category: "operations",
    slug: "business-docs",
    keywords: ["invoice", "receipt", "contract", "letter", "business", "docs", "pdf"],
    icon: "FileText",
  },
  {
    id: "40",
    ...
    category: "communication",
    slug: "career-kit",
    keywords: ["resume", "cv", "cover letter", "signature", "job", "career"],
    icon: "Sparkles",
  },
];
