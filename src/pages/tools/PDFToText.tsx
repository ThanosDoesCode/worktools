...
export default function PDFToText() {
  ...
  const convertToText = async () => {
    ...
    toast({
      title: "Coming Soon",
      description: "PDF to Text conversion requires a backend service. This feature is under development.",
    });
          ...
          <Card className="p-6">
            ...
            <ol className="space-y-3 text-sm text-muted-foreground">
              ...
              <li className="flex gap-3">
                ...
                <span>We extract all text content</span>
              </li>
              <li className="flex gap-3">
