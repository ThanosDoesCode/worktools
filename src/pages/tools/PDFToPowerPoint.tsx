...
export default function PDFToPowerPoint() {
  ...
  const convertToPowerPoint = async () => {
    ...
    toast({
      title: "Coming Soon",
      description: "PDF to PowerPoint conversion requires a backend service. This feature is under development.",
    });
          ...
          <Card className="p-6">
            ...
            <ol className="space-y-3 text-sm text-muted-foreground">
              ...
              <li className="flex gap-3">
                ...
                <span>Each page becomes a slide</span>
              </li>
              <li className="flex gap-3">
                ...
                <span>Download your editable PPTX file</span>
              </li>
            </ol>
          </Card>
