...
export default function PDFToExcel() {
  ...
  const convertToExcel = async () => {
    ...
    toast({
      title: "Coming Soon",
      description: "PDF to Excel conversion requires a backend service. This feature is under development.",
    });
        ...
        <div className="space-y-6">
          <Card className="p-6">
            ...
            <ol className="space-y-3 text-sm text-muted-foreground">
              ...
              <li className="flex gap-3">
                ...
                <span>We detect and extract all tables</span>
              </li>
              <li className="flex gap-3">
                ...
                <span>Download your XLSX spreadsheet</span>
              </li>
            </ol>
          </Card>
          ...
          <Card className="p-6 bg-muted/50">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>• Smart table detection</li>
              <li>• Multiple tables per page</li>
              <li>• Preserves cell formatting</li>
              <li>• Ready for data analysis</li>
            </ul>
          </Card>
        </div>
      </div>
