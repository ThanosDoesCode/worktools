...
export default function PDFToEPUB() {
  ...
  const convertToEPUB = async () => {
    ...
    toast({
      title: "Coming Soon",
      description: "PDF to EPUB conversion requires a backend service. This feature is under development.",
    });
        ...
        <div className="space-y-6">
          <Card className="p-6">
            ...
            <ol className="space-y-3 text-sm text-muted-foreground">
              ...
              <li className="flex gap-3">
                ...
                <span>We convert to e-book format</span>
              </li>
              <li className="flex gap-3">
                ...
                <span>Download your EPUB file</span>
              </li>
            </ol>
          </Card>
          ...
          <Card className="p-6 bg-muted/50">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>• Reflowable text for e-readers</li>
              <li>• Chapter detection</li>
              <li>• Embedded images</li>
              <li>• Kindle & iPad compatible</li>
            </ul>
          </Card>
        </div>
      </div>
