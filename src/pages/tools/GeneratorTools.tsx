      ...
      <Card>
        <CardContent className="p-4 sm:p-6">
          <Tabs defaultValue="password" className="w-full">
            <TabsList className="w-full mb-4 sm:mb-6 flex overflow-x-auto whitespace-nowrap gap-1 justify-start rounded-xl p-1 sm:grid sm:grid-cols-5 sm:gap-1 sm:overflow-visible [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
