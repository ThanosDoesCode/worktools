            ...
            <TabsContent value="uuid" className="space-y-6">
              <div className="space-y-4">
                <div>
                  ...
                  <Slider
                    value={[uuidCount]}
                    onValueChange={(v) => setUuidCount(v[0])}
                    min={1}
                    max={10}
                    step={1}
                    className="mt-2"
                  ...
                  <div className="space-y-2">
                    {generatedUUIDs.map((uuid, i) => (
                      <div key={i} className="p-3 bg-muted rounded-lg flex items-center justify-between">
                        ...
                        <Button variant="ghost" size="icon" onClick={() => copyToClipboard(uuid)}>
                          <Copy className="h-4 w-4" />
                        </Button>
                      </div>
                    ))}
              ...
              <div className="space-y-4">
                ...
                {qrDataUrl && (
                  <div className="flex flex-col items-center space-y-4">
                    ...
                    <Button variant="outline" onClick={() => downloadImage(qrDataUrl, "qrcode.png")}>
              ...
              <div className="space-y-4">
                ...
                {barcodeDataUrl && (
                  <div className="flex flex-col items-center space-y-4">
                    ...
                    <Button variant="outline" onClick={() => downloadImage(barcodeDataUrl, "barcode.png")}>
                      <Download className="mr-2 h-4 w-4" /> Download PNG
                    </Button>
                  </div>
                )}
