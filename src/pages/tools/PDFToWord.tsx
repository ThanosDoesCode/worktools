...
export default function PDFToWord() {
  ...
  const convertToWord = async () => {
    ...
    toast({
      title: "Coming Soon",
      description: "PDF to Word conversion requires a backend service. This feature is under development.",
    });
        ...
        <div className="space-y-6">
          <Card className="p-6">
            ...
            <ol className="space-y-3 text-sm text-muted-foreground">
              ...
              <li className="flex gap-3">
                ...
                <span>We extract text and formatting</span>
              </li>
              <li className="flex gap-3">
                ...
                <span>Download your editable DOCX file</span>
              </li>
            </ol>
          </Card>
          ...
          <Card className="p-6 bg-muted/50">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>• Maintains fonts where possible</li>
