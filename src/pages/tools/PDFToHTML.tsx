...
export default function PDFToHTML() {
  ...
  const convertToHTML = async () => {
    ...
    toast({
      title: "Coming Soon",
      description: "PDF to HTML conversion requires a backend service. This feature is under development.",
    });
          ...
          <Card className="p-6">
            ...
            <ol className="space-y-3 text-sm text-muted-foreground">
              ...
              <li className="flex gap-3">
                ...
                <span>We convert to semantic HTML</span>
              </li>
              <li className="flex gap-3">
                ...
                <span>Download your HTML file</span>
              </li>
            </ol>
          </Card>
